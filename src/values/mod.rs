...
//!
//! 1. **EntityLocation** — where an entity lives in Parquet storage
//! 2. **AdjacencyList** — compressed edge list for graph traversal
//! 3. **PathEntries** — list of entity IDs matching a file path
//!
